...
const faqs = [
  ...
  [
    "Why did my Watch recording stop?",
  ...
  [
    "A recording has not reached my iPhone. What should I do?",
  ...
  [
    "Why were my older recordings not sent automatically?",
  ...
  [
    "Does Auto Segments detect each repetition?",
  ...
  [
    "Why can’t I add a suggested segment to a folder?",
  ...
  [
    "Which file should I keep as a backup?",
  ...
  [
    "Where can I change labels or replay the tutorial?",
...
export default function Support() {
  const subject = encodeURIComponent("WatchMotion Editor support");
  ...
  return (
    <div className="container">
      <header className="page-intro">
        ...
        <p>
          Start with the checks below. If you are still stuck, tell us what
          happened and which device you were using.
        </p>
      </header>
      <div className="support-grid">
        <section className="contact-panel">
          ...
          <p>
            Include your app version, device, OS version, and the steps that led
            to the issue. Screenshots can help—remove private details first.
          </p>
          <a
          ...
          <small>
            Opens your email app. No message is sent until you send it.
            <br />
            Support contact: {site.operator}
          </small>
        </section>
        <section className="requirements">
          ...
          <p>
            Use an Apple Watch paired with your iPhone. The complete workflow
            needs all three devices.
          </p>
          <p>
